...
5. Route multi-layer or high-risk work through `Change-DAG-Author` and then `Change-DAG-Runner`. The author must create or amend a verifiable Change DAG; the runner executes it.
