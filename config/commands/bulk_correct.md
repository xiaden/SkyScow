...
8. Pass the mandatory full `QA-Reviewer` gate after all implementation phases. Security-sensitive, persistence, cache, lifecycle, and cross-layer changes require applicable security review plus test and documentation analysis. Fix MINOR findings and rerun QA; stop for planning gaps, requirement drift, architectural issues, or critical findings.
