...
description: Co-author a substantial document through context gathering, iterative drafting, and reader testing. Use when the user asks to draft or refine a proposal, specification, RFC, PRD, or decision document; do not use for a quick edit or routine code-documentation update.
---
