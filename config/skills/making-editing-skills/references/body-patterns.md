...
|---------|-------------|---------------|
| **Procedural workflow** | Multi-step processes with phase gates and entry/exit criteria | `making-design-documents`, `doc-coauthoring` |
| **Template + dispatch** | The skill is a fill-in-the-blank prompt for dispatching another agent | `dispatching-agents` |
...
| **Meta-guide** | Teaching how to do something (the skill IS the exemplar) | `command-creation-guide`, built-in `customize-opencode` |
