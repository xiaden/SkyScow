...
Fix Kotlin build errors, Gradle configuration issues, and dependency resolution failures with minimal, surgical changes.
...
- [Kotlin Compiler Flags](#kotlin-compiler-flags)
...
- `kotlin-patterns` — Detailed Kotlin patterns and code examples for complex fixes beyond basic build errors
