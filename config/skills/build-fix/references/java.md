...
Fix Java compilation errors, Maven/Gradle configuration issues, and dependency resolution failures with minimal, surgical changes. No refactoring or rewriting — fix the build error only.
...
- [Maven Troubleshooting](#maven-troubleshooting)
...
- `springboot-patterns` — Spring Boot-specific patterns for build and dependency issues
- `quarkus-patterns` — Quarkus-specific patterns for build and dependency issues
