...
Fix C++ build errors, CMake issues, and linker warnings with minimal, surgical changes.
...
- `cpp-coding-standards` — Detailed C++ patterns and code examples for complex fixes beyond basic build errors
